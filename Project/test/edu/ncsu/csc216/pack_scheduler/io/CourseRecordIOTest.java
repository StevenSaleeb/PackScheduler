...
public class CourseRecordIOTest {
	...
	public void testReadValidCourseRecords() {
		...
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "jdyoung2", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "spbalik", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "tbdimitr", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "jtking", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "sesmith5", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "ixdoming", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "jctetter", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "tmbarnes", "@.", "pw", "pw", 3);
		RegistrationManager.getInstance().getFacultyDirectory().addFaculty("First", "Last", "dbsturgi", "@.", "pw", "pw", 3);
		try {
